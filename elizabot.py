...
# Initialize your Telegram bot with your API key
API_KEY = "7560808732:AAGhVR8Ik8of2rDOhVjxqonE5dNLPGSmVv4"  # Replace this with your actual API key
...
eliza = Eliza()
eliza.load('doctor.txt')  # Path to your ELIZA data file (doctor.txt)
...
def handle_message(message):
    ...
    if response is None:
        bot.reply_to(message, "Goodbye! It was nice talking to you.")
    else:
